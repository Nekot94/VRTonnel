	...
	if (typeof AFRAME === 'undefined') {
      ...
      AFRAME.registerComponent('video-controls', {
        ...
        init: function () {
          ...
          this.video_el = document.querySelector(this.video_selector);
            ...
            this.timeText.setAttribute("value", "Loading");
          ...
          this.play_image.addEventListener('click', function (event) {
            ...
            if (!self.video_el.loaded) return;
          ...
          this.bar.addEventListener('click', function (event) {
              ...
              var cursorIntersections = document.getElementById('cursor').components.raycaster.raycaster.intersectObject(this.object3D, true);
              if (cursorIntersections.length > 0) {
                point = cursorIntersections[0].point;
              }
              
              var laserIntersections = document.getElementById('rightHand').components.raycaster.raycaster.intersectObject(this.object3D, true);
 
              if (laserIntersections.length > 0) {

                point = laserIntersections[0].point;
              }
        ...
        //   this.el.appendChild(this.play_image);
          ...
          this.el.appendChild(this.timeText);
          ...
          this.el.sceneEl.addEventListener("loaded", function(){
              ...
              // var raycaster = document.getElementById(activeCursorId).firstElementChild.components.raycaster.raycaster;
      ...
      //                ctx.fillText(this.video_el.readyState, this.bar_canvas.width*0.1, this.bar_canvas.height* 0.65);
                    ...
                    //   ctx.fillText(this.data.infoTextBottom, this.bar_canvas.width/2, this.bar_canvas.height* 0.95);
                      ...
                      spherePos = (this.video_el.currentTime / this.video_el.duration) * 2.6 - 1.3 + " 0.3 0";
                      this.sphere.setAttribute("position",spherePos);
